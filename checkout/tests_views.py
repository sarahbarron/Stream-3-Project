...
class TestCheckOutViews(TestCase):
    ...
    def test_cart(self):
        ...
        page = self.client.post("/checkout/",{'full_name':'name','phone_number':'123', 'street_address1':'my', 'street_address2':'address is', 'town_or_city':'kk', 'county':'ireland', 'country':'ireland','postcode':'eircode', 'credit_card_number': '4242424242424242','cvv':'111', 'expiry_month':'2','expiry_year':'2019','stripe_id':'5898238475892347598', 'id':'1', 'name':'product', 'available_stock':'100', 'price':'30'}, follow=True)
    ...
    def test_cart_session(self):
        ...
        page = self.client.post("/checkout/",{'cart':cart}, follow=True)