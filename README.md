...
- Logged in users have some extra features they can access
    ...
    - View the cart page - to view all items they have added to the cart during their session. You can also amend the quantity required of each product on this page. The cart is accessable from the cart link on the navigation bar.
